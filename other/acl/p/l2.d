...
void main()
{
    ...
    auto N = nq[0];
    auto Q = nq[1];
    alias E = Tuple!(long, "zero", long, "one", long, "inv");
    auto AS = readln.split.map!(a => E(a == "0" ? 1 : 0, a == "1" ? 1 : 0, 0)).array;
    auto segt = LazySegTree!(
        E,
        (a, b) => E(a.zero + b.zero, a.one + b.one, a.inv + b.inv + a.one * b.zero),
        () => E(0, 0, 0),
        bool,
        (bool f, E e) => f ? E(e.one, e.zero, e.zero * e.one - e.inv) : e,
