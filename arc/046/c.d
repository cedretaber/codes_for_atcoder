...
void main()
{
    ...
    sort!"a.a == b.a ? a.b > b.b : a.a < b.a"(YS);

    auto segt = Segtree!(int, "a < b ? a : b", () => INF)(YS.map!"a.b"().array());
    int res;
    foreach (x; XS) {
        if (YS[$-1].a < x.b) continue;
